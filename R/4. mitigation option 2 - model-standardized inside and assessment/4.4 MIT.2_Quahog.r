...
# write.csv(temp_data_avail_df, "results/indices for assessment/quahog/mitigation_2_model-standardized/temp.data.avail.csv", row.names = FALSE)
temp_data_avail_df <- read.csv("results/indices for assessment/quahog/mitigation_2_model-standardized/temp.data.avail.csv")
...
full_RF_df[is.na(full_RF_df$DEPTH),]$ID

full_RF_df[full_RF_df$ID == "201260.3Q.151" ,]$DEPTH <- 63 # same as 199903.3Q.151
...
write.csv(full_RF_df, "results/indices for assessment/quahog/mitigation_2_model-standardized/Full_RF_standardized_tow.csv", row.names = FALSE)
...
RF_df <- read.csv("results/indices for assessment/quahog/mitigation_2_model-standardized/Full_RF_standardized_tow.csv") %>%
...
write.csv(stratified_mean_N_df, "results/indices for assessment/quahog/mitigation_2_model-standardized/MIT.2.stratified.mean.indices.csv", row.names = FALSE)
