...
# E:\Stony Brook job\NYSERDA Offshore wind\R\1.7 tows and indices for assessment\1.7.5 quahog (ratio)
...
load("results/indices for assessment/quahog/mitigation_2_model-standardized/MIT.2.RDtrendS_ratio.Rdata")
...
load("results/indices for assessment/quahog/mitigation_2_model-standardized/MIT.2.RDscaleS_ratio.Rdata")
...
load("results/indices for assessment/quahog/mitigation_2_model-standardized/MIT.2.MCDS_ratio.Rdata")
...
SS_writedat(datlist = data, outfile = "assessment model/quahog/MIT.2 model/Wquahog1.dat", overwrite = TRUE)
...
run_dir_MIT.2 <- "assessment model/quahog/MIT.2 model/"
...
write.csv(SSB_MIT.2_df, "results/stock assessment/quahog/SSB_MIT.2.csv")
...
F_MIT.2_df$Ratio <- F_MIT.2_df$F_weighted/0.019
F_MIT.2_df$Ratio.SD <- F_MIT.2_df$F_weighted_std/0.019

F_MIT.2_df$Scenario <- "MIT.2 Model"

write.csv(F_MIT.2_df, "results/stock assessment/quahog/F_MIT.2.csv")
...
write.csv(ABC_df, "results/stock assessment/quahog/ABC_MIT.2.csv", row.names = FALSE)
