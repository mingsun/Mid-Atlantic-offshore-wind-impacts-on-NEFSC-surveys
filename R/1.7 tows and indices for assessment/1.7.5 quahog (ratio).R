...
stra_area_df <- read.csv("results/stratified.mean.indices/quahog/strata.area.csv") %>% # strata area as mean
...
tow_RDtrendS_df <- read.csv("data/NOAA.stock.data/quahog/TOW_DATA.CSV") %>% 
...
write.csv(RDtrendS_WEE_df, "results/indices for assessment/quahog/WEE/WEE.RDtrendS.csv", row.names = FALSE)
...
save(RDtrendS_WEE_VALUE_ratio, RDtrendS_WEE_STDERR_ratio, file = "results/indices for assessment/quahog/WEE/WEE.RDtrendS_ratio.Rdata")
...
mitigtated_tow_list_df <- read.csv("results/indices for assessment/quahog/mitigation_1_WEA_distance/tow_list.csv") %>%
  filter(YEAR <= 2011) 
...
write.csv(RDtrendS_MIT.1_df, "results/indices for assessment/quahog/mitigation_1_WEA_distance/MIT.1.RDtrendS.csv", row.names = FALSE)
...
save(RDtrendS_MIT.1_VALUE_ratio, RDtrendS_MIT.1_STDERR_ratio, file = "results/indices for assessment/quahog/mitigation_1_WEA_distance/MIT.1.RDtrendS_ratio.Rdata")
...
RDtrendS_MIT.2_df <- read.csv("results/indices for assessment/quahog/mitigation_2_model-standardized/Full_RF_standardized_tow.csv") %>%
...
write.csv(RDtrendS_MIT.2_df, "results/indices for assessment/quahog/mitigation_2_model-standardized/MIT.2.RDtrendS.csv", row.names = FALSE)
...
save(RDtrendS_MIT.2_VALUE_ratio, RDtrendS_MIT.2_STDERR_ratio, file = "results/indices for assessment/quahog/mitigation_2_model-standardized/MIT.2.RDtrendS_ratio.Rdata")
...
RDtrendS_MIT.3_df <- read.csv("results/indices for assessment/quahog/mitigation_3_model-based indices/VAST_RDtrendS/final model/VAST_RDtrendS_Indices.csv") %>%
  rename(VALUE = fit) %>%
...
write.csv(RDtrendS_MIT.3_df, "results/indices for assessment/quahog/mitigation_3_model-based indices/MIT.3.RDtrendS.csv", row.names = FALSE)
...
save(RDtrendS_MIT.3_VALUE_ratio, RDtrendS_MIT.3_STDERR_ratio, file = "results/indices for assessment/quahog/mitigation_3_model-based indices/MIT.3.RDtrendS_ratio.Rdata")
...
write.csv(RDscaleS_full_df, "results/indices for assessment/quahog/original.RDscaleS.csv", row.names = FALSE)
...
write.csv(RDscaleS_WEE_df, "results/indices for assessment/quahog/WEE/WEE.RDscaleS.csv", row.names = FALSE)
...
save(RDscaleS_WEE_VALUE_ratio, RDscaleS_WEE_STDERR_ratio, file = "results/indices for assessment/quahog/WEE/WEE.RDscaleS_ratio.Rdata")
...
write.csv(RDscaleS_MIT.1_df, "results/indices for assessment/quahog/mitigation_1_WEA_distance/MIT.1.RDscaleS.csv", row.names = FALSE)
...
catch_by_tow_MIT.2_df <- read.csv("results/indices for assessment/quahog/mitigation_2_model-standardized/Full_RF_standardized_tow.csv") %>%
...
write.csv(RDscaleS_MIT.2_df, "results/indices for assessment/quahog/mitigation_2_model-standardized/MIT.2.RDscaleS.csv", row.names = FALSE)
...
save(RDscaleS_MIT.2_VALUE_ratio, RDscaleS_MIT.2_STDERR_ratio, file = "results/indices for assessment/quahog/mitigation_2_model-standardized/MIT.2.RDscaleS_ratio.Rdata")
...
catch_by_tow_MIT.3_df <- read.csv("results/stratified.mean.indices/quahog/total.catch.by.tow.csv") %>%
  filter(YEAR <= 2011 & YEAR >= 1997)  # the list of tow for MIT.3


# stratified mean
MIT.3_stratified_mean_N_df <- read.csv("results/indices for assessment/quahog/mitigation_3_model-based indices/VAST_RDscaleS/final model/VAST_RDscaleS_Indices.csv") %>%
  filter(YEAR <= 2011 & YEAR >= 1997) %>%
...
write.csv(RDscaleS_MIT.3_df, "results/indices for assessment/quahog/mitigation_3_model-based indices/MIT.3.RDscaleS.csv", row.names = FALSE)
...
save(RDscaleS_MIT.3_VALUE_ratio, RDscaleS_MIT.3_STDERR_ratio, file = "results/indices for assessment/quahog/mitigation_3_model-based indices/MIT.3.RDscaleS_ratio.Rdata")
...
tow_MCDS_df <- read.csv("results/stratified.mean.indices/quahog/total.catch.by.tow.csv")%>%
  filter(YEAR %in% c(2012, 2015), REGION == "SVAtoSNE")
...
write.csv(MCDS_full_df, "results/indices for assessment/quahog/original.MCDS.csv", row.names = FALSE)
...
write.csv(MCDS_WEE_df, "results/indices for assessment/quahog/WEE/WEE.MCDS.csv", row.names = FALSE)


    ## extract ratio between them
MCDS_WEE_VALUE_ratio <- MCDS_WEE_df$VALUE/MCDS_full_df$VALUE
MCDS_WEE_STDERR_ratio <- MCDS_WEE_df$log_SE/MCDS_full_df$log_SE

save(MCDS_WEE_VALUE_ratio, MCDS_WEE_STDERR_ratio, file = "results/indices for assessment/quahog/WEE/WEE.MCDS_ratio.Rdata")
...
write.csv(MCDS_MIT.1_df, "results/indices for assessment/quahog/mitigation_1_WEA_distance/MIT.1.MCDS.csv", row.names = FALSE)
...
save(MCDS_MIT.1_VALUE_ratio, MCDS_MIT.1_STDERR_ratio, file = "results/indices for assessment/quahog/mitigation_1_WEA_distance/MIT.1.MCDS_ratio.Rdata")
...
tow_MCDS_MIT.2_df <- read.csv("results/indices for assessment/quahog/mitigation_2_model-standardized/Full_RF_standardized_tow.csv") %>%
  filter(YEAR %in% c(2012, 2015)) # load the tow list for MIT.2
...
write.csv(MCDS_MIT.2_df, "results/indices for assessment/quahog/mitigation_2_model-standardized//MIT.2.MCDS.csv", row.names = FALSE)
...
save(MCDS_MIT.2_VALUE_ratio, MCDS_MIT.2_STDERR_ratio, file = "results/indices for assessment/quahog/mitigation_2_model-standardized/MIT.2.MCDS_ratio.Rdata")
...
catch_by_tow_MIT.3_df <- read.csv("results/stratified.mean.indices/quahog/total.catch.by.tow.csv") %>%
  filter(YEAR %in% c(2012, 2015))  # the list of tow for MIT.3


# stratified mean
MCDS_MIT.3_stratified_mean_N_df <- read.csv("results/indices for assessment/quahog/mitigation_3_model-based indices/VAST_MCDS/final model/VAST_MCDS_Indices.csv") %>%
  filter(YEAR %in% c(2012, 2015)) %>%
  rename(STRATIFIED_MEAN_N = fit) %>%
  mutate(SE = (upr - lwr)/(2 * 1.96),
         VAR = SE^2,
...
write.csv(MCDS_MIT.3_df, "results/indices for assessment/quahog/mitigation_3_model-based indices/MIT.3.MCDS.csv", row.names = FALSE)
...
save(MCDS_MIT.3_VALUE_ratio, MCDS_MIT.3_STDERR_ratio, file = "results/indices for assessment/quahog/mitigation_3_model-based indices/MIT.3.MCDS_ratio.Rdata")
