...
save(BART_presence_outside, outside_BART_df, file = "results/spatial model/summer.flounder/models objects/BART_presence_outside.Rdata")
save(BART_BIOMASS_outside, outside_BART_df, file = "results/spatial model/summer.flounder/models objects/BART_BIOMASS_outside.Rdata")
...
for (i in 1:nrow(scenario_df)) {
  ...
  # load(file = paste0("results/spatial model/summer.flounder/models objects/VAST with covaraites/VAST_full_model.Rdata"))
...
for (i in 1:nrow(scenario_df)) {
  ...
  save(VAST_outside_model, file = paste0("results/spatial model/summer.flounder/models objects/VAST/VAST_outside_",
                                                          scenario_df$error.dist[i], ".",scenario_df$link.func[i], "_model.Rdata"))
  # load(file = paste0("results/spatial model/summer.flounder/models objects/VAST with covaraites/VAST_outside_model.Rdata"))
