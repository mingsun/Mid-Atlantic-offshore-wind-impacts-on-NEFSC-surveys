...
BART_comp <- read.csv("results/spatial model/summer.flounder/BART_abundance_comparison.csv")
...
write.csv(Pred_df, "results/spatial model/summer.flounder/Pred_df.csv")
...
write.csv(RMSE_diff_df, "results/spatial model/summer.flounder/RMSE_diff_df.csv")
...
write.csv(CV_diff_df, "results/spatial model/summer.flounder/CV_diff_df.csv")
