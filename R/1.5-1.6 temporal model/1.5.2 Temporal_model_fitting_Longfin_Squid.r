...
load("results/spatial model/longfin.squid/models objects/TW.GAM_dist_outside.Rdata")
...
write.csv(TW.GAM_temp_df, "results/temporal model/longfin.squid/Tweedie.GAM_YEAR_Indices.csv", row.names = FALSE)

save(TW.GAM_temp_fall, full_WG_df, file = "results/temporal model/longfin.squid/models objects/TW.GAM_temp_fall.Rdata")
save(TW.GAM_temp_spring, full_WG_df, file = "results/temporal model/longfin.squid/models objects/TW.GAM_temp_spring.Rdata")
...
save(DELTA.GAM_fit_year_fall, DELTA.GAM_PREDICTED_fall, file = "results/temporal model/longfin.squid/models objects/DELTA.GAM_year_effect_GAM_fall.Rdata")
...
save(DELTA.GAM_fit_year_spring, DELTA.GAM_PREDICTED_spring, file = "results/temporal model/longfin.squid/models objects/DELTA.GAM_year_effect_GAM_spring.Rdata")
...
load("results/spatial model/longfin.squid/models objects/DELTA.S1.GAM_dist_outside.Rdata")
load("results/spatial model/longfin.squid/models objects/DELTA.S2.GAM_dist_outside.Rdata")
...
write.csv(DELTA.GAM_temp_df, "results/temporal model/longfin.squid/Delta.GAM_YEAR_Indices.csv", row.names = FALSE)

save(DELTA.S1.GAM_temp_fall, full_DELTA.GAM_df, file = "results/temporal model/longfin.squid/models objects/DELTA.s1.GAM_temp_fall.Rdata")
save(DELTA.S2.GAM_temp_fall, full_DELTA.GAM_df, file = "results/temporal model/longfin.squid/models objects/DELTA.s2.GAM_temp_fall.Rdata")
save(DELTA.S1.GAM_temp_spring, full_DELTA.GAM_df, file = "results/temporal model/longfin.squid/models objects/DELTA.s1.GAM_temp_spring.Rdata")
save(DELTA.S2.GAM_temp_spring, full_DELTA.GAM_df, file = "results/temporal model/longfin.squid/models objects/DELTA.s2.GAM_temp_spring.Rdata")
...
load("results/spatial model/longfin.squid/models objects/RF_dist_outside.Rdata")
...
write.csv(RF_temp_df, "results/temporal model/longfin.squid/RF_YEAR_Indices.csv", row.names = FALSE)

save(RF_temp_fall, full_RF_df, file = "results/temporal model/longfin.squid/models objects/RF_temp_fall.Rdata")
save(RF_temp_spring, full_RF_df, file = "results/temporal model/longfin.squid/models objects/RF_temp_spring.Rdata")
...
save(BART.GAM_fit_year_fall, BART_comp_fall_dataset_df, file = "results/temporal model/longfin.squid/models objects/BART_year_effect_GAM_fall.Rdata")
...
save(BART.GAM_fit_year_spring, BART_comp_spring_dataset_df, file = "results/temporal model/longfin.squid/models objects/BART_year_effect_GAM_spring.Rdata")
...
load("results/spatial model/longfin.squid/models objects/BART_presence_outside.Rdata")
load("results/spatial model/longfin.squid/models objects/BART_BIOMASS_outside.Rdata")
...
save(BART.GAM_fit_year_annual, BART_comp_annual_dataset_df, file = "results/temporal model/longfin.squid/models objects/BART_year_effect_GAM_annual.Rdata")
...
write.csv(BART_temp_df, "results/temporal model/longfin.squid/BART_YEAR_Indices.csv", row.names = FALSE)

save(BART_presence_fall, fall_BART_df, file = "results/temporal model/longfin.squid/models objects/BART_presence_fall.Rdata")
save(BART_BIOMASS_fall, fall_BART_df, file = "results/temporal model/longfin.squid/models objects/BART_BIOMASS_fall.Rdata")
save(BART_presence_spring, spring_BART_df, file = "results/temporal model/longfin.squid/models objects/BART_presence_spring.Rdata")
save(BART_BIOMASS_spring, spring_BART_df, file = "results/temporal model/longfin.squid/models objects/BART_BIOMASS_spring.Rdata")
...
for (i in 1:nrow(scenario_df)) {
  ...
  VAST_temp_fall <- tryCatch(
    # attempt to fit the model
    {
      VAST_temp_fall <- fit_model(settings = settings,
                                  ...
                                  working_dir = "results/temporal model/longfin.squid/models objects/VAST/")
  ...
  save(VAST_temp_fall, file = paste0("results/temporal model/longfin.squid/models objects/VAST_fall_",
...
write.csv(scenario_df, "results/temporal model/longfin.squid/models objects/VAST/VAST_fall_model_selection.csv")

 ### save the fitted value ----

load("results/temporal model/longfin.squid/models objects/VAST_temp_fall.Rdata")

VAST_fall_data <- plot(VAST_temp_fall, working_dir = "results/temporal model/longfin.squid/models objects/VAST/figure/")
...
for (i in 2:nrow(scenario_df)) {
  ...
  save(VAST_temp_spring, file = paste0("results/temporal model/longfin.squid/models objects/VAST_spring_",
                                                   scenario_df$error.dist[i], ".",scenario_df$link.func[i], "_model.Rdata"))
...
write.csv(scenario_df, "results/temporal model/longfin.squid/models objects/VAST/VAST_spring_model_selection.csv")


### save the fitted value ----

load("results/temporal model/longfin.squid/models objects/VAST_temp_spring.Rdata")

VAST_spring_data <- plot(VAST_temp_spring, working_dir = "results/temporal model/longfin.squid/models objects/VAST/figure/")
...
load("results/spatial model/longfin.squid/models objects/VAST_outside_model.Rdata")

VAST_annual_data <- plot(VAST_outside_model, working_dir = "results/temporal model/longfin.squid/models objects/VAST/figure/")
...
write.csv(VAST_temp_df, "results/temporal model/longfin.squid/VAST_YEAR_Indices.csv", row.names = FALSE)
...
## combine and save ----
DELTA.GAM_temp_df <- rbind(DELTA.GAM_temp_fall_df, DELTA.GAM_temp_spring_df, DELTA.GAM_temp_annual_df) 
write.csv(DELTA.GAM_temp_df, "results/temporal model/longfin.squid/simple.Delta.GAM_YEAR_Indices.csv", row.names = FALSE)
