...
TW.GAM_df <- read.csv("results/temporal model/quahog/full dataset/Tweedie.GAM_YEAR_Indices.csv")
DELTA.GAM_df <- read.csv("results/temporal model/quahog/full dataset/simple.Delta.GAM_YEAR_Indices.csv")
# DELTA.GAM_df <- read.csv("results/temporal model/quahog/Delta.GAM_YEAR_Indices.csv")
BART_df <- read.csv("results/temporal model/quahog/full dataset/BART_YEAR_Indices.csv")
RF_df <- read.csv("results/temporal model/quahog/full dataset/RF_YEAR_Indices.csv")
VAST_df <- read.csv("results/temporal model/quahog/full dataset/VAST_YEAR_Indices.csv")
...
png("plots/temporal model/quahog/model_based_indices_comparison.png",  width = 8, height = 6, units = 'in', res = 800)
print(indices_p)
dev.off()
...
write.csv(cor_df, "results/temporal model/quahog/full dataset/correlation.between.model-based.indices.df.csv", row.names = FALSE)
...
CV_df <- ind_df %>%
  ...
  group_by(MODEL) %>%
  mutate(MEAN_CHANGE_CV = mean(PROPORTIONAL_CHANGE_CV, rm = TRUE))

write.csv(CV_df, "results/temporal model/quahog/full dataset/CV.between.model-based.indices.df.csv", row.names = FALSE)
...
write.csv(RE_df, "results/temporal model/quahog/full dataset/RE.between.model-based.indices.df.csv", row.names = FALSE)
...
write.csv(trend_bias_df, "results/temporal model/quahog/full dataset//trend.bias.between.model-based.indices.df.csv", row.names = FALSE)
