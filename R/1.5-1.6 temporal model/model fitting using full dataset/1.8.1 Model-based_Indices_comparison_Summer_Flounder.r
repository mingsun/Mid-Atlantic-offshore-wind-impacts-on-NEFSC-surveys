...
TW.GAM_df <- read.csv("results/temporal model/summer.flounder/full dataset/Tweedie.GAM_YEAR_Indices.csv")
DELTA.GAM_df <- read.csv("results/temporal model/summer.flounder/full dataset/simple.Delta.GAM_YEAR_Indices.csv")
# DELTA.GAM_df <- read.csv("results/temporal model/summer.flounder/Delta.GAM_YEAR_Indices.csv")
BART_df <- read.csv("results/temporal model/summer.flounder/full dataset/BART_YEAR_Indices.csv")
RF_df <- read.csv("results/temporal model/summer.flounder/full dataset/RF_YEAR_Indices.csv")
VAST_df <- read.csv("results/temporal model/summer.flounder/full dataset/VAST_YEAR_Indices.csv")
...
png("plots/temporal model/summer.flounder/model_based_indices_comparison.png",  width = 8, height = 6, units = 'in', res = 800)
print(indices_p)
dev.off()
...
write.csv(cor_df, "results/temporal model/summer.flounder/full dataset/correlation.between.model-based.indices.df.csv", row.names = FALSE)
...
write.csv(CV_df, "results/temporal model/summer.flounder/full dataset/CV.between.model-based.indices.df.csv", row.names = FALSE)
...
write.csv(RE_df, "results/temporal model/summer.flounder/full dataset/RE.between.model-based.indices.df.csv", row.names = FALSE)
...
write.csv(trend_bias_df, "results/temporal model/summer.flounder/full dataset/trend.bias.between.model-based.indices.df.csv", row.names = FALSE)
